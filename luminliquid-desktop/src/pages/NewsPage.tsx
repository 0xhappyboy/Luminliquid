    ...
    componentDidMount() {
        ...
        this.newsUpdateInterval = setInterval(() => {
            if (this.state.autoRefresh) {
                // Add new news articles periodically
    ...
    private renderNewsDetail = () => {
        ...
        if (!selectedArticle) {
            return (
                <div style={{
                    ...
                    flexDirection: 'column',
                    backgroundColor: theme === 'dark' ? '#0F1116' : '#FFFFFF',
                    minHeight: 0 // 重要：确保flex容器可以收缩
                }}>
                    {/* Top: Market Data & Charts */}
                    <div style={{
                        flex: '1 1 50%', // 明确指定flex比例
                        display: 'flex',
                        flexDirection: 'column',
                        minHeight: 0,
                        padding: '16px',
        ...
        return (
            <div style={{
                ...
                flexDirection: 'column',
                backgroundColor: theme === 'dark' ? '#0F1116' : '#FFFFFF',
                minHeight: 0 // 关键：确保flex容器可以正确计算高度
            }}>
