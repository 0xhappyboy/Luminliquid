...
interface AptosContractAnalysisPanelProps {
    theme: 'dark' | 'light';
...
class AptosContractAnalysisPanel extends React.Component<AptosContractAnalysisPanelProps> {
                                ...
                                <div style={{ marginBottom: '12px' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                                        ...
                                        <span style={{
                                            ...
                                            fontSize: '10px',
                                            fontWeight: '600',
                                            ...this.getFunctionTypeColor(func.type, theme)
                                        }}>
                                            {func.type}
                                        </span>
                                        ...
                                        <span style={{
                                            ...
                                            fontSize: '10px',
                                            fontWeight: '600',
                                            ...this.getVisibilityColor(func.visibility, theme)
                                        }}>
                                            {func.visibility}
                                        </span>
                                        
                                        {/* Generic Types */}
                                        {func.genericTypes.map((genericType, idx) => (
                                            <span key={idx} style={{
                                                padding: '2px 6px',
                                                borderRadius: '4px',
                                                fontSize: '10px',
...
export default AptosContractAnalysisPanel;