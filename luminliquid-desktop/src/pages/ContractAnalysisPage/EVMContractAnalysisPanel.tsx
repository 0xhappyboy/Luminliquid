...
interface EVMContractAnalysisPanelProps {
    theme: 'dark' | 'light';
...
class EVMContractAnalysisPanel extends React.Component<EVMContractAnalysisPanelProps> {
...
export default EVMContractAnalysisPanel;